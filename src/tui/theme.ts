...
export const fullKeyboardShortcuts = [
  ...
  { key: 'A', description: 'Toggle activity view (full-screen)', category: 'Views' },
  { key: 'h', description: 'Toggle show/hide closed tasks', category: 'Views' },
  { key: 'V', description: 'Toggle tasks/iterations list (Shift+V)', category: 'Views' },
  { key: 'o', description: 'Cycle right panel views (details/output/cli/prompt)', category: 'Views' },
  { key: 'v', description: 'Toggle CLI log view (in output panel)', category: 'Views' },
  { key: 'O', description: 'Jump to prompt preview (Shift+O)', category: 'Views' },
  { key: 't', description: 'Cycle subagent detail level', category: 'Views' },
  { key: 'T', description: 'Toggle subagent tree panel', category: 'Views' },
  { key: 'L', description: 'Toggle activity log panel', category: 'Views' },
  { key: '1', description: 'Activity filter: All', category: 'Views' },
  { key: '2', description: 'Activity filter: Tasks', category: 'Views' },
  { key: '3', description: 'Activity filter: Merges', category: 'Views' },
  ...
  { key: 'Tab', description: 'Cycle focus between panels', category: 'Navigation' },
